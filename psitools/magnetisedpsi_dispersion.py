...
# MRI extension was written by Francesco Lovascio.
...
class MHDPSIDispersion():
    ...
    def matrix_KN(self,w):
        ...
        KNxy=0
        KNxz=0
        KNyx=By*self.kx*-1*denominator-3j*Bdotk*Omega*0.5*denominator**2
        KNyy=Bdotk*denominator
        KNyz=-1*By*self.kz*denominator
    ...
    def matrix_P(self, w):
        ...
        return (np.asarray([[Pxx, Pxy, Pxz], [Pyx, Pyy, Pyz], [Pzx, Pzy, Pzz]]))+self.matrix_xiKN(w)
